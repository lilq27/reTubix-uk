...
<div class="imgAlign">
	...
	<c:forEach var="good" items="${goodTitle}" begin="0" end="79" step="1">

		<a href="user/showMovie?idx=${good.idx}"> <img
			src="${pageContext.request.contextPath}/resources/images/poster/${good.title }.png"
